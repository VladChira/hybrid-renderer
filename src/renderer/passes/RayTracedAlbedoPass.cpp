...
namespace hybrid::renderer
{
    ...
    RayTracedAlbedoPass::RayTracedAlbedoPass(GLShaderProgram *program,
    ...
    bool RayTracedAlbedoPass::Execute(const RayTracedAlbedoPassInput &input)
    {
        HYBRID_PROFILE_ZONE_N("RayTracedAlbedoPass::Execute");
        HYBRID_PROFILE_GL_ZONE("RayTracedAlbedoPass");
        ...
        if (!settings.enable_raytrace_albedo)
        {
            return true;
        }
