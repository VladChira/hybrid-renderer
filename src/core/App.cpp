                          ...
                          renderer::Renderer &renderer)
    {
        ...
        while (!m_should_quit && !platform.ShouldClose())
        {
            ...
            ui::UiState ui_state{};
            {
                ...
                ui_state.viewport_raytrace_primary_albedo_texture = renderer_outputs.raytrace_primary_albedo;
                ui_state.viewport_raytrace_reflections_texture = renderer_outputs.raytrace_reflections;
