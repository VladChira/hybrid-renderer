                          ...
                          renderer::Renderer &renderer)
    {
        ...
        while (!m_should_quit && !platform.ShouldClose())
        {
            ...
            ui::UiState ui_state{};
            {
                ...
                ui_state.viewport_scene_radiance_texture = renderer_outputs.scene_radiance;
                ui_state.viewport_scene_radiance_prev_texture = renderer_outputs.scene_radiance_prev;
